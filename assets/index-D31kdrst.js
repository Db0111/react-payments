...
`;
const Input = (props) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(StyledInput, { ...props });
};
...
const useErrorArrayState = (length2, onAllValid) => {
  const [errorState, setErrorState] = reactExports.useState(() => Array(length2).fill(false));
  const updateErrorState = (idx, hasError) => {
    setErrorState((prev2) => {
      const updated = [...prev2];
...
function useInputValidation(initialErrorState, validLength) {
  const { errorState, updateErrorState } = useErrorArrayState(
    initialErrorState.length,
    () => setErrorMessage("")
  );
...
const StyledHelperTextWrapper$3 = newStyled.div`
  height: 30px;
`;
const INITIAL_ERROR_STATES$3 = [false];
const VALID_LENGTH$2 = 3;
const CVCInput = ({ values, onChange, onValidChange }) => {
  const { errorState, errorMessage, validate } = useInputValidation(
    INITIAL_ERROR_STATES$3,
    VALID_LENGTH$2
  );
  reactExports.useEffect(() => {
    const isValid = errorState.every((error) => error === false) && values.every((value) => value.length === 3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledCVCInput, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledLabel$3, { children: "CVC" }),
...
const StyledHelperTextWrapper$2 = newStyled.div`
  height: 30px;
`;
const INITIAL_ERROR_STATES$2 = Array.from({ length: 4 }, () => false);
const VALID_LENGTH$1 = 4;
const CardNumberInput = ({ values, onChange, onValidChange }) => {
  const { errorState, errorMessage, validate } = useInputValidation(
    INITIAL_ERROR_STATES$2,
    VALID_LENGTH$1
  );
  const inputRefs = reactExports.useRef([]);
  reactExports.useEffect(() => {
    const isValid = errorState.every((error) => error === false) && values.every((value) => value.length === 4);
    onValidChange(isValid);
  }, [errorState, values, onValidChange]);
  const handleChange = ({ e, idx }) => {
    var _a;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledCardNumberInput, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledLabel$2, { children: "카드 번호" }),
...
function useExpDateValidation(initialErrorState, values, validationFn) {
  const { errorState, updateErrorState } = useErrorArrayState(
    initialErrorState.length,
    () => setErrorMessage("")
  );
  const [errorMessage, setErrorMessage] = reactExports.useState("");
  const validateExpirationDate = (params) => {
    try {
...
const getCurrentYear = (date = /* @__PURE__ */ new Date()) => {
  return date.getFullYear();
};
const getCurrentMonth = (date = /* @__PURE__ */ new Date()) => {
  return date.getMonth();
};
const checkValidYear = (value) => {
  const currentYear = getCurrentYear() % 1e3;
...
const expirationDateValidation = (values, { e, idx }, validLength) => {
...
const StyledHelperTextWrapper$1 = newStyled.div`
  height: 30px;
`;
const INITIAL_ERROR_STATES$1 = [false, false];
const validationCallback = (values, params, validLength) => expirationDateValidation(values, params, validLength);
const ExpirationDateInput = ({ values, onChange, onValidChange }) => {
  const placeHolders = ["MM", "YY"];
  const { errorState, errorMessage, validateExpirationDate } = useExpDateValidation(
    INITIAL_ERROR_STATES$1,
    values,
    validationCallback
  );
  const inputRefs = reactExports.useRef([]);
  reactExports.useEffect(() => {
    const isValid = errorState.every((error) => error === false) && values.every((value) => value.length === 2);
    onValidChange(isValid);
  }, [errorState, values, onValidChange]);
  const handleChange = ({ e, idx }) => {
    var _a;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledExpirationDateInput, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledLabel$1, { children: "유효기간" }),
...
const getCardTypeImage = (firstCardInput) => {
...
const PreviewCard = ({ cardNumber, expirationDate, cardCompany }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledPreviewCard, { cardCompany, children: [
...
const StyledPasswordInput = newStyled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  margin-top: 10px;
...
const PasswordInput = ({ values, onChange, onValidChange }) => {
  const { errorState, errorMessage, validate } = useInputValidation(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledPasswordInput, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledLabel, { children: "비밀번호 앞 2자리" }),
...
const StyledDropdownWrapper = newStyled.div`
  position: relative;
  width: 100%;
  margin-bottom: 30px;
`;
const StyledSelectedOption = newStyled.div`
  ...
  font-size: 12px;
`;
const StyledArrowButton = newStyled.button`
  position: absolute;
  top: 5px;
  right: 10px;
  width: 1rem;
...
`;
const StyledOptionList = newStyled.ul`
  position: absolute;
  top: 100;
  left: 0;
  width: 100%;
  ...
  z-index: 10;
`;
const StyledOptionItem = newStyled.li`
  padding: 8px;
  cursor: pointer;
  font-size: 12px;
...
const StyledFormSection = newStyled.div`
  display: flex;
  flex-direction: column;
  gap: 10px;
...
const FormSection = ({ title, subtitle, children }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledFormSection, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { type: "title", text: title }),
    subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { type: "subTitle", text: subtitle }),
    children
  ] });
};
function useFormField(length2 = 1) {
  const [values, setValues] = reactExports.useState(Array(length2).fill(""));
...
function useCardForm() {
  ...
  const handleCardCompanySelect = (value) => {
...
const CardPage = () => {
  ...
  const formSteps = [
    ...
    },
    {
      ...
      component: /* @__PURE__ */ jsxRuntimeExports.jsx(Dropdown, { selected: cardCompany, onChange: handleCardCompanySelect })
    },
    {
      id: "expirationDate",
    ...
    },
    {
      ...
      component: /* @__PURE__ */ jsxRuntimeExports.jsx(CVCInput, { values: cvc.values, onChange: cvc.handleInput, onValidChange: cvc.setIsValid })
    },
    {
      id: "password",
      title: CARD_PAGE_TEXT.PASSWORD_TITLE,
      subtitle: CARD_PAGE_TEXT.PASSWORD_SUBTITLE,
      shouldShow: () => cardNumber.isValid && cardCompany !== "" && expirationDate.isValid && cvc.isValid,
      component: /* @__PURE__ */ jsxRuntimeExports.jsx(
        PasswordInput,
        {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledCardPage, { children: [
    ...
    formSteps.slice().reverse().map((step) => {
...
const StyledImage = newStyled.img`
  ...
  height: 76px;
`;
const StyledTextWrapper = newStyled.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
const RegisterSuccess = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledPage, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StyledImage, { src: "./success.png" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(StyledTextWrapper, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { type: "title", text: `${cardNumber}로 시작하는` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { type: "title", text: `${cardCompany}가 등록되었어요.` })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { text: "확인", onClick: navigateToCardPage })
  ] });
};
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/registered", element: /* @__PURE__ */ jsxRuntimeExports.jsx(RegisterSuccess, {}) })
  ] }) });
}
